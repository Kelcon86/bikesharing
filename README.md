...
Using the tripduration broken down by hour and minute on the x axis and the count of bikes on the y axis, we can see the duration times for users in August 2019. The peak trip duration was just 5 minutes and the vast majority of trips were under 20 minutes. <br/>
...
Using the same x and y axis as the previous graph, I added gender to the color and filter fields to see how gender affected the trip duration. While we could see that there were far more male users, the trip duration remained short (5-6 minutes) for all users. <br/>
...
Using a heatmap, I graphed the count of trips broken down by weekday, hour and gender. Amongst both genders 8 AM and 5-7 PM were the peak times for rides, which is consistent with the commuter theory mentioned previously. <br/>
...
Using a horizontal bar chart I graphed the peak hours for rides in August 2019, showing that the hours of 5-7 PM were the most popular time to ride. <br/>
...
Using a symbal map we can see the top ending ride locations. By dropping the count of rides into the color and size filters, we are able to see that some of the most popular ending locations are along the Hudson River Greenway, a bike trail with water views. <br/>
